...
<head>
    ...
    <title> Cotizaciones Mantenimiento </title>
</head>
...
<body>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td> <?php echo "dato 3" ?> </td>
                    <td> <?php echo "dato 3" ?> </td>
                    <td> <a href="formModificarCotizacionesElectronicas.php" class="btn-tabla-modificar">Modificar</a>
                    </td>
    ...
    <div class="seccion_funcionesExtra">
        <section>
            <a href="formAgregarCotizacionesMantenimiento.php" class="btn-tabla-agregar">Agregar</a>
